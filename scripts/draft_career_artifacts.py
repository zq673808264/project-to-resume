...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--project-name", help="Project name for output subfolder. Defaults to the project path in the evidence pack.")
...
def main() -> int:
    ...
    project_slug = safe_slug(args.project_name or infer_project_name(evidence, project_path))
    out_dir = Path(args.out_dir).resolve() if args.flat else Path(args.out_dir).resolve() / person / project_slug
